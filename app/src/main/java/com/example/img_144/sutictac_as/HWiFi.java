...
public class HWiFi extends AppCompatActivity implements ViewStub.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hwi_fi);
        initFilter();
        ...
        mChannel = mManager.initialize(this, getMainLooper(), new WifiP2pManager.ChannelListener() {
            ...
            public void onChannelDisconnected() {
                ...
                mManager.initialize(HWiFi.this,getMainLooper(),this);
            }
        });
