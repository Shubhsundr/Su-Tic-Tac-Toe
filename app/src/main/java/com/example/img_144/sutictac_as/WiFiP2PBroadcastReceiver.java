...
public class WiFiP2PBroadcastReceiver extends BroadcastReceiver {
    ...
    private HWiFi mHWiFi;
    public WiFiP2PBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel,HWiFi mhwifi){
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                mHWiFi.setIsWifiP2pEnabled(true);
                Log.e("WiFiP2PBroadcast","enable");
            } else {
                mHWiFi.setIsWifiP2pEnabled(false);
...
//                    WifiP2pManager.EXTRA_WIFI_P2P_DEVICE));
            ...
            mHWiFi.updateThisDevice((WifiP2pDevice) intent.getParcelableExtra(
                    WifiP2pManager.EXTRA_WIFI_P2P_DEVICE));
    ...
    private WifiP2pManager.PeerListListener peerListListener = new WifiP2pManager.PeerListListener() {
        ...
        public void onPeersAvailable(WifiP2pDeviceList peerList) {
            ...
            HWiFi.peers.clear();
            HWiFi.peers.addAll(peerList.getDeviceList());
